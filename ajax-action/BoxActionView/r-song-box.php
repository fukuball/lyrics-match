...
$short_url_json = json_decode(shell_exec("curl https://www.googleapis.com/urlshortener/v1/url -H 'Content-Type: application/json' -d "."'{".'"longUrl"'.": ".'"http://www.indievox.com/"'."}'"));
echo $short_url_json['id'];
