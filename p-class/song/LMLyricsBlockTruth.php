<?php
/**
 * LMLyricsBlockTruth.php is lyrics_block_truth model class
 *
 * PHP version 5
 *
 * @category PHP
 ...
 */
 ...
 /**
  * LMLyricsBlockTruth is lyrics_block_truth model class
  *
  * An example of a LMLyricsBlockTruth is:
  *
  * <code>
  *   $lyric_block_truth_obj = new LMLyricsBlockTruth($instance_key);
  * </code>
  *
  * @category PHP
  * @package  /p-class/song/
  ...
  * @link     http://sarasti.cs.nccu.edu.tw
  */
class LMLyricsBlockTruth extends LMActiveRecord
{
