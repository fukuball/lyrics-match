<?php
/**
 * LMMusicFeatureMatrix.php is music_feature_matrix model class
 *
 * PHP version 5
 *
 * @category PHP
 ...
 */
 ...
 /**
  * LMMusicFeatureMatrix is music_feature_matrix model class
  *
  * An example of a LMMusicFeatureMatrix is:
  *
  * <code>
  *   $music_feature_matrix_obj = new LMMusicFeatureMatrix($instance_key);
  * </code>
  *
  * @category PHP
  * @package  /p-class/matrix/
  ...
  * @link     http://sarasti.cs.nccu.edu.tw
  */
class LMMusicFeatureMatrix extends LMActiveRecord
{
...
}// end class LMMusicFeatureMatrix
?>
