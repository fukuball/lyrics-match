<?php
/**
 * LMMusicAudioWordMatrix.php is music_audio_word_matrix model class
 *
 * PHP version 5
 *
 * @category PHP
 ...
 */
 ...
 /**
  * LMMusicAudioWordMatrix is music_audio_word_matrix model class
  *
  * An example of a LMMusicAudioWordMatrix is:
  *
  * <code>
  *   $music_audio_word_matrix_obj = new LMMusicAudioWordMatrix($instance_key);
  * </code>
  *
  * @category PHP
  * @package  /p-class/matrix/
  ...
  * @link     http://sarasti.cs.nccu.edu.tw
  */
class LMMusicAudioWordMatrix extends LMActiveRecord
{
...
}// end class LMMusicAudioWordMatrix
?>
