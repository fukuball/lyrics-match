<?php
/**
 * LMMusicAudioWordMatrixGod.php is music_audio_word_matrix god class
 *
 * PHP version 5
 *
 * @category PHP
 ...
 */
 ...
 /**
  * LMMusicAudioWordMatrixGod is music_audio_word_matrix god class
  *
  * An example of a LMMusicAudioWordMatrixGod is:
  *
  * <code>
  *   $music_audio_word_matrix_god_obj = new LMMusicAudioWordMatrixGod();
  * </code>
  *
  * @category PHP
  * @package  /p-class/matrix/
...
class LMMusicAudioWordMatrixGod extends LMActiveRecordGod
{
...
}// end class LMMusicAudioWordMatrixGod
?>