<?php
/**
 * LMPerformer.php is performer model class
 *
 * PHP version 5
 *
 * @category PHP
 ...
 */
 ...
 /**
  * LMPerformer is performer model class
  *
  * An example of a LMPerformer is:
  *
  * <code>
  *   $performer_obj = new LMPerformer($instance_key);
  * </code>
  *
  * @category PHP
  * @package  /p-class/performer/
  ...
  * @link     http://sarasti.cs.nccu.edu.tw
  */
class LMPerformer extends LMActiveRecord
{
