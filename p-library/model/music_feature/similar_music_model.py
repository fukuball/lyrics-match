...
if (has_model_data=="true") :
   ...
   similar = np.dot(similar_music_model_normalized,input_song_matrix_normalized.T) / (np.linalg.norm(similar_music_model_normalized)*np.linalg.norm(input_song_matrix_normalized.T))
